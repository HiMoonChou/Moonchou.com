...
export const Clients = () => {
  return (
    <div className="mb-16">
      <FadeInStagger className="mt-16" faste="true">
        <div className=" relative m-auto items-center w-full overflow-hidden  before:absolute before:left-0 before:top-0 before:z-[2] before:h-full before:w-[100px] before:bg-[linear-gradient(to_right,black_0%,rgba(0,0,0,0)_100%)] before:content-[''] after:absolute after:right-0 after:top-0 after:z-[2] after:h-full after:w-[100px] after:-scale-x-100 after:bg-[linear-gradient(to_right,black_0%,rgba(0,0,0,0)_100%)] after:content-['']">
          <div className="animate-infinite-slider flex w-[calc(800px*6)]">
